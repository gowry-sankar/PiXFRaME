...
<script
	...
	<style type="text/css">
body {
	background-image: url("http://wallscreenart.com/wp-content/uploads/2017/01/black-wallpaper-High-Definition-89Y.jpg");
}
label{
	color: white;
}
...
<form class="form-horizontal" action="addCategory" method="post" onsubmit="return formCategory()" enctype="multipart/form-data">
  <div class="form-group">
    <label class="control-label col-sm-offset-2 col-sm-3" for="email">Genre ID:</label>
    <div class="col-sm-3">
      <input type="text" class= "form-control" name="categoryId" value="${category.categoryId}" readonly="true">
    </div>
  </div>
    <div class="form-group">
    <label class="control-label col-sm-offset-2 col-sm-3" for="pwd">Genre Name :</label>
    <div class="col-sm-3"> 
      <input type="text" class= "form-control" name="categoryName" value="${category.categoryName}">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-offset-2 col-sm-3" for="pwd">Genre Description :</label>
    <div class="col-sm-3"> 
